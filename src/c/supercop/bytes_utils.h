...
static void println_128(const char m[], const void*const abytes){
    const uint8_t *const a = (const uint8_t*const) abytes;
    print_128(m,a,"\n");
}
...
static size_t hexstr_to_bytes(uint8_t *dst, size_t dst_size, char *hexstr){
