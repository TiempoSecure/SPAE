...
#include <stdint.h>
#include "spae_aes128_sle_impl.h"

#define SPAE_PASS SPAE_SLE_PASS
#define SPAE_BLOCKSIZE SPAE_SLE_BLOCKSIZE
#define SPAE_KEYSIZE SPAE_SLE_KEYSIZE
#define SPAE_BLOCKSIZE64 SPAE_SLE_BLOCKSIZE64
